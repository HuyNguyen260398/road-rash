...
const VARIATIONS: Variation[] = [
  {
    ...
    durationDays: 4,
    description:
      "Limestone peaks and switchback passes on the northern frontier loop.",
  },
  {
    name: "Da Lat Coffee Country Ride",
    ...
    vehicle: "MOTORBIKE",
    durationDays: 3,
    description: "Pine forests, waterfalls, and highland coffee farms.",
  },
  {
    name: "Mui Ne Coastal Cruise",
    ...
    vehicle: "CAR",
    durationDays: 2,
    description: "Red sand dunes and a long quiet coastal road.",
  },
  {
    name: "Mekong Delta Slow Roll",
    ...
    vehicle: "CAR",
    durationDays: 3,
    description: "Floating markets, river ferries, and orchard backroads.",
  },
  {
    name: "Sapa Terraces Trek Drive",
    location: "Sapa Rice Terraces",
    city: "Sapa",
    province: "Lao Cai",
    country: "Vietnam",
    tripType: "MOUNTAIN",
    vehicle: "CAR",
    durationDays: 3,
    description: "Terraced valleys and the climb toward Fansipan.",
  },
  {
    name: "Hoi An Old Town Pedal",
    ...
    vehicle: "BICYCLE",
    durationDays: 1,
    description: "Lantern-lit lanes and rice-paddy bike paths.",
  },
  {
    name: "Phong Nha Cave Country",
    location: "Phong Nha-Ke Bang",
    city: "Dong Hoi",
    province: "Quang Binh",
    country: "Vietnam",
    tripType: "CAMPING",
    vehicle: "MOTORBIKE",
    durationDays: 3,
    description: "Jungle karst and the world's biggest caves.",
  },
  {
    name: "Nha Trang Bay Drive",
    ...
    vehicle: "CAR",
    durationDays: 2,
    description: "Island-dotted bay and a breezy coastal highway.",
  },
  {
    name: "Pleiku Highland Crossing",
    ...
    vehicle: "MOTORBIKE",
    durationDays: 4,
    description: "Volcanic crater lakes and red-earth plantations.",
  },
  {
    name: "Cat Ba Island Explorer",
    ...
    vehicle: "OTHER",
    durationDays: 2,
    description: "Limestone islets, hidden coves, and a national park ride.",
  },
  {
    name: "Saigon Street Food Spin",
    ...
    vehicle: "MOTORBIKE",
    durationDays: 1,
    description: "A loop of the city's best street-food corners.",
  },
];
...
async function main(): Promise<void> {
  ...
  if (!template) {
    throw new Error(
      "No existing trip to use as a template — create one first.",
    );
  }
  ...
  for (const seed of seeds) {
    ...
    if (!res.ok) {
      ...
      throw new Error(
        `POST /trips failed for "${seed.name}": ${res.status} ${body}`,
      );
    }
